    ...
    public void handle(Request request) {
        ...
        if(result != null && this.ownHost.equals(queryRequest.getRequesterHost()) && // Result found. Request originated from this Host/Port
            ...
            // UI.show result or notify file downloads handler
                ...
                this.ownPort != queryRequest.getGetRequesterPort()){
            QueryResponse response = new QueryResponse(ownHost,ownPort,queryRequest.getRequesterHost(),
                    queryRequest.getGetRequesterPort());
            ...
            int count = 0;
            while(destinationEntry != null || count < 50){  // find a random neighbour who is online
            ...
            if(destinationEntry == null || queryRequest.getHopCount() > maxHopCount){ // cant find a neighbour OR hop count exceeded
